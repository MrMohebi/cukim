...
Route::prefix("/res")->group(function (){
    Route::group(["middleware"=>["resToken"]], function (){
        ...
        Route::post('uploadFoodImage',[food::class,'uploadFoodImage']);
        Route::post('deleteFoodImage',[food::class,'deleteFoodImage']);
